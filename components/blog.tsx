            ...
            <Card className="w-full max-w-2xl">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  I write about AI, Typescript, React & NextJS, Node.js, AWS, and other technologies on my Hashnode blog. Check out
                  my latest articles and tutorials.
                </p>
                <Button asChild>
                  <Link href="https://glasse.hashnode.dev" target="_blank" rel="noopener noreferrer">
